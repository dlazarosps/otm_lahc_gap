...
# ./bin/main 1000000 300 10 < ./instances/$instances > ./output/$output
# echo $output

# output="output-limit-1000000-list-100-alpha-30-in-$instances"
# ./bin/main 1000000 100 30 < ./instances/$instances > ./output/$output
# echo $output
